...
body{
	background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0)),url("pat6.jpg");
   height: 100vh; 
...
<h1>Appointment details - Dermatology</h1>
...
//$s=$_POST["sno"];
$x=mysqli_query($conn,"select * from dermatology1");
